...
init        clrf PORTA      ;Init PORTS
            ...
            movlw b'01111111' ; nastaví control register timer2
            movwf T2CON
            movlw b'01111111' ; kdy pøeteèe timer2
            movwf PR2
...
dotaz       bsf PORTB, 1  ;start bity XX - 10
            ...
            goto $-3 ;@todo pridat ochranu proti zamrznuti
            
            btfsc PORTB, 1  ;ceka az skonci prvni start bit X - 1
            goto $-1 ;@todo pridat ochranu proti zamrznuti

...
init        clrf PORTA      ;Init PORTS
            ...
            movlw b'00001001' ;0 left justifed, FOSC/2 na rychlost prevodu 0, 00, nastaveni analogových vstupu a hodnotu k porovnání 0000
            movwf ADCON1
            ...
            movlw b'00010110' ; nastaví control register timer2
            movwf T2CON
...
watch       bcf conf, WATCHOVER ;nastavi jako nepreteceny
...
;pøi pøeteèení timeru 0, až po fázi synchronizace procesorù    
...
if_58       btfsc o_d, 7 ;pokud alarm zapnut nefungujou tlacitka
            ...
            ; Kontrola zda minule bylo stejne tlacitko. Funguje pokud bylo 2x po sobe stejne tlacitko
            movf last_ir_58, W
            movwf r1
            movf ir_58, W
            movwf last_ir_58
            ...
            bcf STATUS, C ; otoèí (zaokrouhli) registr r1, minule tlacitko
            rrf r1, F
            bcf STATUS, C
            rrf r1, F
            bcf STATUS, C
            rrf r1, F
            bcf STATUS, C ; otoèí (zaokrouhli) registr r2, nynejsi tlacitko
            rrf r2, F
            bcf STATUS, C
            rrf r2, F
            bcf STATUS, C
            ...
            movf r2, W ; porovna a pokud jsou stejné, pokracuje dal
            subwf r1, W
            btfss STATUS, Z
            return
...
if_128      btfsc o_d, 7 ;pokud alarm zapnut nefungujou tlacitka
            nop;return ;po dokonceni vyvoje vratit return z duvodu bezpecnosti a je to dùležité !!!!!
            bcf STATUS, C
            rrf ir_128, W
            movwf r1
            bcf STATUS, C
...
start       bcf PCLATH,3 ;Select page 0
            ...
            bsf PCLATH,3 ;Select page 1
            call okna ;spouští obsluhu jednotlivých okének
            bcf PCLATH,3 ;Select page 0
...
okna        movf ir_90, W
            ...
            movwf r1
            comf r1, F ;udelám dvojkový doplnìk
            movf o1tar, W
            andlw b'11110000' ;odseknu konecnou cast

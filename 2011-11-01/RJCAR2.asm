...
init    movlw .2    ;oznaceni tohoto procesoru 2
        movwf num
...
prijem  btfsc PORTB, 0  ;ceka az skonci prvni start bit
        ...
        btfss r5, 0  ;pokud 1 skoci a kontroluje prijate reg
        goto ende
...
ende    btfsc PORTB, 0    ;ceka az skonci stopbity
        goto $-1 ;@todo pridat ochranu proti zamrznuti

        btfss r5, 0  ;pokud 0 vysle sve registry nebo ceka X bitu pokud neni pro nej
        call vysilej
...
vysilej comf num, W     ;pokud neni pro nej ceka X bitu
        addwf cil, W
        movwf r1
        incfsz r1, F
        goto cekej
...
cekej   call w40c
        movlw .81 ;bude cekat 81 bitu
        movwf r3
        call w100c
        decfsz r3, F
        goto $-2
        btfsc PORTB, 0  ;ceka az skonci stop bity
        goto $-1 ;@todo pridat ochranu proti zamrznuti
        return

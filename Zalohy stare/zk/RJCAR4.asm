...
start   movlw b'10000101' ;00 Fosc/2, 000 AN0, 1 start & in progres, 0, 1 shut up (povoleno)
        movwf ADCON0
        ...
        movlw b'10001101' ;00 Fosc/2, 000 AN0, 1 start & in progres, 0, 1 shut up (povoleno)
        movwf ADCON0
        btfsc ADCON0, 2   ;ceka nez skonci AD prevod
        goto $-1
        movf ADRESH, W    ;kontroluje zda je zmena od minule
        ...
        movlw b'10010101' ;00 Fosc/2, 000 AN0, 1 start & in progres, 0, 1 shut up (povoleno)
        movwf ADCON0
        btfsc ADCON0, 2   ;ceka nez skonci AD prevod
        goto $-1
        movf ADRESH, W    ;kontroluje zda je zmena od minule
        ...
        movlw b'10011101' ;00 Fosc/2, 000 AN0, 1 start & in progres, 0, 1 shut up (povoleno)
        movwf ADCON0
        btfsc ADCON0, 2   ;ceka nez skonci AD prevod
        goto $-1
        movf ADRESH, W    ;kontroluje zda je zmena od minule
        ...
        movlw b'10101101' ;00 Fosc/2, 000 AN0, 1 start & in progres, 0, 1 shut up (povoleno)
        movwf ADCON0
        btfsc ADCON0, 2   ;ceka nez skonci AD prevod
        goto $-1
        movf ADRESH, W    ;kontroluje zda je zmena od minule
        ...
        movlw b'10110101' ;00 Fosc/2, 000 AN0, 1 start & in progres, 0, 1 shut up (povoleno)
        movwf ADCON0
        btfsc ADCON0, 2   ;ceka nez skonci AD prevod
        goto $-1
        movf ADRESH, W    ;kontroluje zda je zmena od minule
        ...
        movlw b'10111101' ;00 Fosc/2, 000 AN0, 1 start & in progres, 0, 1 shut up (povoleno)
        movwf ADCON0
        btfsc ADCON0, 2   ;ceka nez skonci AD prevod
        goto $-1
        movf ADRESH, W    ;kontroluje zda je zmena od minule

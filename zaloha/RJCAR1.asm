...
init    movlw .1    ;oznaceni tohoto procesoru 1 Hlavní procesor
        movwf num
...
;obslouzeni okynek, (vy)stahuje v závislosti na aktualni a cilové poloze
okna	movf ir_90, W
...
start   btfsc conf, T0OF ;pokud timer 0 pøetekl, spustí jeho obsluhu
		bcf PCLATH,4
		bcf PCLATH,3 ;Select page 0
